...
include("admin_function.php");
 ...
 {
	 header("location:admin_add_blood.php");
 }
...
$sql="SELECT * FROM blood  $limit ";

 $textline1="Total Blood : $rows";
								...
								$list.= "<table class='table table-striped' >";
									$list.= "<tr>
										...
										while($row=$result->fetch_assoc())
										{
											...
											$list.="<tr>";
												$list.= "<td>$i</td>";
												$list.= "<td>".$row["blood_group"]."</td>";
                                                $list.= "<td>".$row["blood_ml"]."</td>";
                                                 
												$list.= "<td><a href='admin_del_blood.php?id=".$row["id"]."' class='btn btn-danger btn-sm'><i class='fa fa-trash'></i></a></td>";
											$list.="</tr>";
										}
								$list.= "</table>";
						}
...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-9" >
			<h3><i class="fa fa-bank"></i> View blood Details </h3><hr>    
