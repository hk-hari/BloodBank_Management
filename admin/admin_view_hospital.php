									...
									$list.= "<tr>
										...
										while($row=$result->fetch_assoc())
										{
											...
											$list.="<tr>";
                                                ...
                                                $list.= "<td><a href='admin_add_blood.php?id=".$row["COUNTRY_ID"]."&hospital_name=".$row["COUNTRY_NAME"]."' class='btn btn-danger btn-sm'><i class='fa fa-plus'></i></a></td>";
												$list.= "<td><a href='admin_del_hospital.php?id=".$row["COUNTRY_ID"]."' class='btn btn-danger btn-sm'><i class='fa fa-trash'></i></a></td>";
											$list.="</tr>";
										}
								$list.= "</table>";
						}
...
<div class="container">
	<div class="row">
		...
		<div class="col-sm-9" >
			<h3><i class="fa fa-bank"></i> View Hospital Details </h3><hr>    
